...
datasets = [
    (val_anno_path, val_img_dir, "NYU_SmallHand_val"),  # it is important to have 'val' in validation dataset name, look for 'val' below
    (tr_anno_path, tr_img_dir, "NYU_SmallHand")
]


tr_hdf5_path = os.path.join(dataset_dir, "NYU_Small_Hand_train_dataset.h5")
val_hdf5_path = os.path.join(dataset_dir, "NYU_Small_Hand_val_dataset.h5")
...
def getAnnotation(dataset, imgIdx, kinectIdx):
    ...
    parts = ['F1_KNU3_A', 'xxx', 'F1_KNU2_A', 'xxx', 'F1_KNU1_A', 'F1_KNU1_B', 
        'F2_KNU3_A', 'xxx', 'F2_KNU2_A', 'xxx', 'F2_KNU1_A', 'F2_KNU1_B', 
        'F3_KNU3_A', 'xxx', 'F3_KNU2_A', 'xxx', 'F3_KNU1_A', 'F3_KNU1_B', 
        'F4_KNU3_A', 'xxx', 'F4_KNU2_A', 'xxx', 'F4_KNU1_A', 'F4_KNU1_B', 
        'TH_KNU3_A', 'xxx', 'TH_KNU2_A', 'xxx', 'TH_KNU1_A', 'TH_KNU1_B', 
        'PALM_1', 'xxx', 'xxx', 'xxx', 'xxx', 'xxx']
    validParts = np.array(parts)
    validParts = validParts != "xxx"
    jnt_uvd = jnt_uvd[validParts, ...]
